...
<?php
	...
	echo "<div id=\"welcome\">Welcome $firstName $lastName</div><br>";	
	echo "<a href='account_page.php/$firstName+$lastName' id=\"accountLink\" >Account Details</a>";
?>

<!--The commented code below should be replaced with a welcome message with the user's name at the top right hand side of the page-->



<!--
<div class="userForm">
<form  name="userInfo" method="POST" action="verifyId.php">

<div id="loginName">User Name: <input name="userName" type="text" size="20em"></div><br>

<div id="loginPassword">Password: <input type="text" name="userPassword" size="20em"></div>

<input id="login" type="submit" name="userInfoSubmit" value="Log In">
</form>

<input id="login" type="button" value="Register" onClick="parent.location='signup.php'">
</br>
<input id="login" type="submit" id="forgotLogin" onclick="forgotInfo()" value="Forgot Login Info?">
</div>
-->
